...
export GOOGLE_WEBHOOK_URL="${GOOGLE_WEBHOOK_URL:-${BACKEND_PUBLIC_BASE}/webhook/google}"
export NEXT_PUBLIC_API_BASE="${NEXT_PUBLIC_API_BASE:-/api}"
export NEXT_PUBLIC_BACKEND_DIRECT="${NEXT_PUBLIC_BACKEND_DIRECT:-${BACKEND_PUBLIC_BASE}}"
